...
let splash_text = ["o toki e toki pona!", "sudo rm -rf --no-preserve-root /", "i use arch btw!", "Open source!", "rabble rabble privacy rabble rabble!", "something something digital footprint something something!", "o kalamawala!", "also try dottwav.neocities.org!", "#1 death hater!", "10 PRINT \"HELLO\"<br>20 GOTO 10!", "Elon Musk has a net worth of over $1,000,000,000,000!", "I ♥ text art!", "release the Epstein files!", "<span style='animation: spin 1s linear infinite; display: inline-block;'>spinning pixels!</span>", "No AI!", "also try touching grass!", "insert splash text here!", "war isn't murder, they're call casualties!", "Dirty commie rat!", "be more prepared for the next insurrection!", "death to DST!", "I'm a socialist      but like a chill one!", "it's a democratic hoax, folks, have you even seen the DOW?", "Indie web!", "Hitler was a bad person!", "cheatcode marquee", "null", "this reminds me of 1984!", "built with a 1970s mainframe!", "I  ♥ Terry Davis!", "Compatible with TempleOS!", "The revolution will not be televised!", "CrazyCattle3D!", "Hello internet, welcome to Game Theory!", "Free Palestine!", "We seem to spend so much time living in someone else's nostalgia.", "Overhead, without any fuss, the stars were going out.", "it's extremely illegal to say...", "Unhireable!", "Fascism is not to be debated, it is to be destroyed!", "First they came for the ... and I did not speak out.", "Stay gold, Ponyboy!", "print(\"Hello, World!\")", "also try https://henryvaniersel.ca/gavriil!", "inconsistently styled!", "Subscribe to my newsletter!", "Keyboard-optimised!", "Tested on Firefox-based browsers!", "<span style='font-family: \"Comic Sans MS\"'>Consistent font usage!</span>", "BC: The best place on Earth!", "Elbows Up!", "Human-made!", "Powered by both my brain cells!", "Powered by Linux!", "Powered by Neovim!", "Powered by Arch!", "Powered by sleep deprivation!", "Powered by HTML!", "Powered by blue jeans!", "Powered by black hoodies!", "No one left to kill in the sky!", "WW1 Censor!", "No one left to kill in the sky!", "Waiting for the Great Leap Forwards!", "Melt ICE!", "████████ ████████ bill clinton ███ █████ ███████████", "Hosted on corporate slop!", "Henry's Site", "ZnVjayBmYXNjaXNtCg==", "Beta test my game!", "Free malware!", "any/all!", "They're putting chemicals in the water!", "Evolving!", "On the VSB's blacklist!", "Shoutout to Zhi Su!", "Read the Hitchhiker's Guide to the Galaxy!", "Watch Andor!", "🏴‍☠️🏴‍☠️🏴‍☠️", "Technical Difficulties!", "(Web) Hostile Architect!", "je ne parle pas français!", "The power of music!", "YYYY-MM-DD!", "RSS support coming soon!", "High Treason!", "Minecraft reference!", "Anti-monarchist!", "Anti-fascist!", "Anti-racist!", "Anti-bigotry!","Anti-war!", "Feminist!", "Socialist!", "Very annoying!", "o moli e sina!", "Je sais manger le verre; cela ne me fait pas mal!", "mi ken moku e kiwen lukin. ona li ken ala pakala e mi!", "15!", "Transit user!", "Ban cars! (in urban areas)", "Skytrain user!", "I can eat glass, it cannot hurt me!", "Privacy is a human right!", "Linguistics!", "The big Marx in the sky!", "The revolution is just a t-shirt away!", "If you've got a blacklist, I wanna be on it!", "Work in progress!", "I'll live dumb and die as a casualty!", "Abolish minimum voting age!", "Don't Look Up!", "Younger than GTA IV!", "Ban this website!", "...", "my password is ************!", "Rotoscoped!", "Unicode support!", "Not POSIX compliant!", "Made in Canada!", "Cornerstone of the economy!", "", "Clock included!", "This was a triumph!", "Ban anything and everything that you see as threatening!", "A revisionist version of history!", "Don't be an Effective Altruist!", "<a href='javascript:alert(`idiot`)'>Click here for more!</a>", "DRM free!", "<span style='font-family:nasin-nanpa'>mi toki e toki+pona</span>", "What a year!", "And the universe said I love you!", "OpenAI's law: every 3 months, the world gets worse", "fortune | cowsay | lolcat!", "The TV made me do it!", "Jailbroken!", "Into our town, The Hangman came!", "Leftist!", "Happy face!", "His name is on the list!", "The 9 Billion Names of God!", "Also try sleeping!", "Wishes vaguely ill of the King!", "Overthinking it!", "Start your own revolution and cut out the middleman!", "The Eve of Destruction!", "Kill them, they're a socialist!", "There's nothing that I can do, until it happens to me!", "Take the money and run!", "Two dead horses in a tight race!", "Liberalism: condemning every war but the one happening right now!", "Free Luigi!", "Political!", "Ironic!", "Urbanist!", "I'm gonna buy myself a sandbox!", "Hates Palantir!", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "Look at the lawman beating up the wrong guy!", "Give the anarchist a cigarette!", "Communism looks good on paper, but in practice it's usually sabotaged by a military coup d'etat financed by the CIA!"]
